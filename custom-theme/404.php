<?php
/**
 * 404. Missing project URLs match ProjectPage.jsx empty state.
 * Other unknown URLs keep an editorial page-not-found (React redirects home).
 */
...
$missing_project = creative_studio_is_missing_project();

get_header();
?>
<div class="flex min-h-screen flex-col justify-center px-5 pt-28 md:px-10">
  <?php if ($missing_project) : ?>
    <h1 class="font-display text-5xl tracking-[-0.05em]">Project not found.</h1>
    <a
