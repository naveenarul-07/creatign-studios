export const projects = [
  {
    ...
    description:
      'NEON asked us to translate after-hours energy into a living identity. We built a modular brand language that flexes from physical installations to a cinematic digital platform — colour, type and motion working as one instrument.',
    challenge:
      'The existing mark felt decorative rather than operational. The brand needed a system that could hold events, merch, editorial and an immersive web presence without losing heat.',
    approach:
      'We started with light as material. A reduced wordmark, a custom kinetic type treatment and a palette that shifts from void-black to electric lime. Motion rules govern every reveal so the brand never sits still.',
    process: [
  ...
  },
  {
    ...
    description:
      'MONO is a product for people who design other products. We distilled a complex workspace into a calm, precise interface with an editorial rhythm — density without noise.',
    challenge:
      'Feature sprawl had made the product feel like a tool cabinet. Users needed flow: fewer decisions, faster making, a surface that felt considered.',
    approach:
      'We rebuilt information architecture around intent, not modules. Typography, spacing and a monochrome system do the heavy lifting. Motion is functional: it explains, never decorates.',
    process: [
  ...
  },
  {
    ...
    description:
      'ARC needed a home as considered as the buildings it represents. We designed a cinematic archive — large stills, slow pans, and a publishing system that treats projects like exhibitions.',
    challenge:
      'Portfolio sites for architecture tend to flatten work into grids. ARC wanted gravity: scale, sequence, and a sense of walking through space.',
    approach:
      'We used scroll as architecture. Chapters, thresholds and reveals mimic moving through a building. The CMS lets studios author spatial stories without touching code.',
    process: [
  ...
  },
  {
    ...
    description:
      'NOVA sits between science and culture. We created a mark that behaves like a particle — stable in print, alive in motion — and a verbal system that speaks with precision and wonder.',
    challenge:
      'Deep-tech brands often hide behind abstraction. NOVA needed to feel human, credible and slightly otherworldly without slipping into cliché sci-fi.',
    approach:
      'A geometric wordmark, a custom constellation grid and photography that favours process over polish. Motion is orbital: elements find each other rather than bounce.',
    process: [
  ...
  },
  {
    ...
    description:
      'FORM invited us to put materiality online. We designed an experience where every object has weight, light and a sound — a digital gallery that rewards lingering.',
    challenge:
      'How do you make people slow down on the internet? The work had to feel tactile in a medium that usually rushes.',
    approach:
      'Cursor as hand. Hover as proximity. Scroll as walking. We paired reduced type with rich object studies and spatial audio cues that never shout.',
    process: [
  ...
  },
  {
    ...
    description:
      'PULSE makes listening devices. We turned sound into a visual language: a living waveform, a timing system, and a product film grammar that feels like bass in the chest.',
    challenge:
      'Audio brands often look like speaker spec sheets. PULSE needed culture, not hardware theatre.',
    approach:
      'We designed a motion bible first, then derived still identity from it. If it does not work at 24fps, it is not the brand.',
    process: [
  ...
  },
  {
    ...
    description:
      'ECHO publishes long, sharp writing on culture. We gave it a typographic house — generous measure, cinematic openers, and a reading experience that respects time.',
    challenge:
      'Most magazines on the web still look like blogs. ECHO needed the authority of print with the fluidity of a native app.',
    approach:
      'Type is the product. We designed a custom scale, issue-based colourways and page transitions that feel like turning a heavy leaf.',
    process: [
...
export const services = [
  {
    ...
    description:
      'We clarify what a brand stands for, who it is for, and how it should behave. Research, verbal identity, brand architecture and go-to-market stories that hold under pressure.',
  ...
  },
  {
    ...
    description:
      'Identity as a working kit, not a logo lockup. We design systems with enough constraint to be recognisable and enough range to stay alive for years.',
  ...
  },
  {
    ...
    description:
      'We design websites as experiences: pacing, hierarchy, and interaction that feel inevitable. Desktop theatre, mobile clarity.',
  ...
  },
  {
    ...
    description:
      'From cinematic marketing sites to product platforms. We engineer for motion, accessibility and real-world performance — not just the staging URL.',
  ...
  },
  {
    ...
    description:
      'We design how things arrive, leave and breathe. Motion guidelines, launch films, and micro-interactions that make a product feel inevitable.',
  ...
  },
  {
    ...
    description:
      'Experiences that respond to presence — cursor, scroll, space. Built for launches, exhibitions and always-on digital flagships.',
...
export const testimonials = [
  {
    id: 't1',
    quote:
      'THE STUDIO DIDN\'T JUST DESIGN OUR WEBSITE. THEY HELPED US REDEFINE HOW OUR BRAND SHOWS UP DIGITALLY.',
    name: 'Elena Voss',
  ...
  },
  {
    id: 't2',
    quote:
      'WORKING WITH THEM FELT LIKE GAINING A CREATIVE DIRECTOR, A STRATEGIST AND A TECHNICAL CO-FOUNDER AT ONCE.',
    name: 'Marcus Hale',
  ...
  },
  {
    id: 't3',
    quote:
      'RARE TO FIND A TEAM THAT CARES ABOUT TYPE, MOTION AND ENGINEERING WITH THE SAME INTENSITY. THE WORK HOLDS UP.',
    name: 'Amina Rahman',
